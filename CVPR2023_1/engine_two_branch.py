...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    for data_iter_step, (samples, targets) in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        with torch.cuda.amp.autocast():
            ...
            classification_loss = 0.9 *criterion(outputs, targets.squeeze())
            #loss_twobranch =  0.1 * loss_twobranch
            loss_mask = 0.1 * loss_mask
            #loss = loss_twobranch + classification_loss + loss_mask
            #classification_loss = criterion(outputs, targets.squeeze())
            #loss = loss_twobranch + classification_loss

            loss = classification_loss + loss_mask 
        ...
        metric_logger.update(loss_mask = loss_mask)
