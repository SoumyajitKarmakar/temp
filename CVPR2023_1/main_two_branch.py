...
from patchDis import PatchDis
from aggregation import VIT
...
def main(args):
    ...
    dataset_train = DataClass(split='train', transform=train_transform, download=download)
    dataset_val = DataClass(split='test', transform=test_transform, download=download)
    print(dataset_train)
